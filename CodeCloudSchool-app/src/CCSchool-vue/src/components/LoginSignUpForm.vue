  ...
  try {
    ...
    if (typeof response === 'string') {
      ...
      if (user.role === 'Student') {
        ...
        localStorage.setItem('lectId', user.userID)
        localStorage.setItem('userName', user.name)

        console.log('lecturer id:', user.userID)
  ...
  <form @submit.prevent>
    <div class="flex flex-col items-center p-6 w-full max-w-md mx-auto">
      ...
      <template v-if="currentFormVariant === 'login'">
        ...
        <Dropdown
          placeholder="Are you a Student, Lecturer, or Admin?"
          v-model="role"
          :options="roleOptions"
          optionValue="value"
          optionLabel="label"
          class="minimal-dropdown w-full mb-4"
        />
      ...
      <template v-else>
        ...
        <Dropdown
          ...
          optionValue="value"
          optionLabel="label"
          class="minimal-dropdown w-full mb-2"
        />
